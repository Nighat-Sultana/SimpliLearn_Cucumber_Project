$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("file:src/test/java/features/Canculator.feature");
formatter.feature({
...
formatter.match({
  "location": "StepDefinition.CaculatorStepDefinition.i_have_a_calculator()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "StepDefinition.CaculatorStepDefinition.i_add_and(int,int)"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "StepDefinition.CaculatorStepDefinition.i_should_get_the_result_as(int)"
});
formatter.result({
  "status": "passed"
});
